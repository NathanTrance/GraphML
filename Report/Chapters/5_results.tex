...
& +Both     & \textbf{0.9741} & \textbf{0.9079} & 0.9314 & \textbf{0.8363} & 0.9041 & 0.8571 & \textbf{0.9882} \\
\midrule
\multirow{4}{*}{Elliptic} 
...
& +Both     & 0.8380 & 0.5716 & 0.7116 & \textbf{0.6573} & 0.5012 & \textbf{0.5623} & 0.7568 \\
\bottomrule
\end{tabular}%
}
\end{table}
...
Table~\ref{tab:recall_at_k} extracts the primary metric for direct comparison across methods and datasets. RP-GAAP achieves the best Recall@K on YelpChi~(+0.46) and T-Finance~(+1.11), while the combined RP-GAAP+Both ties for best on Elliptic~(+0.37) and ties with RP-GAAP on Tolokers~(+1.25). The largest absolute gain is observed on Tolokers, where RP-GAAP and the combined variant both achieve 0.5623 vs.\ the baseline 0.5498. On Elliptic, RP-GAAP and focal loss both reach 0.7359, offering a modest improvement over the 0.7322 baseline.
